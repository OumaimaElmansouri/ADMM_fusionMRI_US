function [x2,fopt,niter] = Descente_grad_xus(y2,x1,d,alpha,c2,gama,tau1,tau2,tau3,display)
...
a = reshape(a,n1*n2,1);
x0 = y2+c;
f = @(x)f1(x,y2,a,gama,tau1,tau2,tau3);
gradf = @(x)gradf1 (x,y2,a,gama,tau1,tau2,tau3);
